...
public class JPack {
	...
	private static int checkArgs(String[] args) {
		...
		if (args[ARG_MODE].equals("-c")) {
			...
			System.err.println("Unknown mode '" + args[ARG_MODE] + "', must be one of '-c', '-d' or '-t'.");
			return MODE_ERROR;
		}
	}

	private static void printUsage() {
		System.out.println("Usage: java " + JPack.class.getSimpleName() + " -c|-d source [destination]");
	}
}
