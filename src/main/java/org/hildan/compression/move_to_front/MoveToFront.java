package org.hildan.compression.move_to_front;
 ...
 * decoded) by the same {@code MoveToFront} object. However, between encoding and
 * decoding processes, the list has to be reinitialized using {@link #reset()}, or a
 * new {@code MoveToFront} object has to be used.
 * </p>
 * <p>
