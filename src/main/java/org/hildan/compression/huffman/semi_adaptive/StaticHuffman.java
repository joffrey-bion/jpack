...
/**
 * This static class uses Huffman algorithm to encode a text file into a binary file, or decode a
 * binary file (previously encoded via this encoder) into a text file.
 * <p>
 * The encoded file is written as follows:
 * </p>
 * <ul>
 * <li>The size of the original source file in bytes, as a {@code Long}.</li>
 * <li>A binary representation of the Huffman tree used to encode the file (or nothing if the source
 * file is empty).</li>
 * <li>The encoded stream representing the characters of the source file (or nothing if the source
 * file is empty).</li>
 * <li>If the last byte was incomplete, it is completed by as many 0 as necessary.</li>
 * </ul>
 * <p>
 * The encoding of the Huffman tree is done via a pre-order enumeration: for each internal node, a 0
 * is written, followed by the left subtree (0-subtree) then the right subtree (1-subtree). Each
 * leaf is encoded by a 1 followed by the code of the character it represents (as a
 * {@code Character}).
 * </p>
 *
...
public class StaticHuffman {
     ...
     * @param destName
     *            The relative path to the destination binary file to create/overwrite.
     * @throws IOException
    ...
    /**
     * Creates the Huffman tree corresponding to the frequencies of the characters in the specified
     * file.
     * 
     * @param filename
     *            The relative path to the source text file whose Huffman tree is desired.
     * @return The Huffman tree corresponding to the frequencies of the characters in the specified
     *         file.
     * @throws IOException
    ...
    /**
     * Encodes the given tree into the binary destination file, via a pre-order enumeration. See
     * this class description for details.
     * 
     * @param writer
    ...
    /**
     * Decodes the tree from the specified binary stream. See this class's description for details.
     * 
     * @param input
